        ...
        <label className="relative w-full h-full group">
            <textarea
                ...
                className={classNames(
                    ...
                    'bg-neutral-90 group-hover:bg-onSurface group-hover:bg-opacity-10',
            ...
            <span
                className={classNames(
                    ...
                    'transition-all w-full group-hover:bg-onSurface group-hover:bg-neutral-90',
                    'bg-neutral-90 bg-from-transparent rounded-t-lg peer-placeholder-shown:bg-opacity-0'
                )}
            >
